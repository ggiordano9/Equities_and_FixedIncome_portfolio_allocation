 ...
 "cells": [
  ...
  },
  {
   ...
   "outputs": [
    ...
    {
     "data": {
      "image/png": "\n",
      "text/plain": [
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  1156.869995      0.017422\n",
       "2021-11-23  1109.030029     -0.041353\n",
       "\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  1156.869995      0.017422       0.004011   0.551696     -0.028981\n",
       "2021-11-23  1109.030029     -0.041353       0.003586   0.550046     -0.029841\n",
       "\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  164.350006      0.021315\n",
       "2021-11-23  168.279999      0.023912\n",
       "\n",
       "[2849 rows x 2 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  164.350006      0.021315       0.385106   0.220083      1.658945\n",
       "2021-11-23  168.279999      0.023912       0.380215   0.219528      1.640859\n",
       "\n",
       "[2598 rows x 5 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  2926.040039     -0.017623\n",
       "2021-11-23  2915.639893     -0.003554\n",
       "\n",
       "[2849 rows x 2 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  2926.040039     -0.017623       0.550802   0.239572      2.215624\n",
       "2021-11-23  2915.639893     -0.003554       0.552327   0.239530      2.222376\n",
       "\n",
       "[2598 rows x 5 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  123.529999     -0.019058\n",
       "2021-11-23  125.050003      0.012305\n",
       "\n",
       "[2849 rows x 2 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  123.529999     -0.019058      -0.386875   0.304341     -1.336904\n",
       "2021-11-23  125.050003      0.012305      -0.382174   0.304519     -1.320684\n",
       "\n",
       "[2598 rows x 5 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  343.820007     -0.003391\n",
       "2021-11-23  348.950012      0.014921\n",
       "\n",
       "[2849 rows x 2 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  343.820007     -0.003391       0.191146   0.206243      0.829829\n",
       "2021-11-23  348.950012      0.014921       0.219269   0.206249      0.966159\n",
       "\n",
       "[2598 rows x 5 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "      <th>Ticker</th>\n",
       "      <th>weights</th>\n",
       "      <th>Weighted Annual Return</th>\n",
       "      <th>Weighted Annual SD</th>\n",
       "      <th>Weighted Sharpe Ratio</th>\n",
       "    </tr>\n",
       "  </thead>\n",
       "  <tbody>\n",
       "    <tr>\n",
      ...
      "text/plain": [
       "  Ticker   weights  Weighted Annual Return  Weighted Annual SD  \\\n",
       "0   TSLA  0.448430                0.001608            0.246657   \n",
       "1    JPM  0.224215                0.085250            0.049222   \n",
       "2  GOOGL  0.174888                0.096595            0.041891   \n",
       "3    GPN  0.098655               -0.037703            0.030042   \n",
       "4   SBAC  0.053812                0.011799            0.011099   \n",
       "\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  4682.939941     -0.003197\n",
       "2021-11-23  4690.700195      0.001657\n",
       "\n",
       "[2849 rows x 2 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-11-22  4682.939941     -0.003197       0.282235   0.120417      2.177720\n",
       "2021-11-23  4690.700195      0.001657       0.278256   0.120333      2.146177\n",
       "\n",
       "[2598 rows x 5 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "25277  2021-09-01        24.07     7.80     9.62     6.65    HAL\n",
       "\n",
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-05-01        31.29     2.95    17.31    11.03   TSLA\n",
       "2021-09-01        30.46     2.95    17.31    10.20   TSLA\n",
       "\n",
       "[75 rows x 5 columns]"
      ]
     },
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-05-01        27.98     1.11    16.09    10.79    JPM\n",
       "2021-09-01        28.00     1.11    16.35    10.55    JPM\n",
       "\n",
       "[75 rows x 5 columns]"
      ]
     },
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-05-01        22.29     0.48     9.91    11.90  GOOGL\n",
       "2021-09-01        22.89     0.48    10.79    11.62  GOOGL\n",
       "\n",
       "[75 rows x 5 columns]"
      ]
     },
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-05-01        18.51     0.16    10.95     7.40    GPN\n",
       "2021-09-01        19.29     1.25    10.98     7.05    GPN\n",
       "\n",
       "[75 rows x 5 columns]"
      ]
     },
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2021-05-01        14.74     3.41     5.98     5.35   SBAC\n",
       "2021-09-01        14.74     3.41     5.98     5.35   SBAC\n",
       "\n",
       "[75 rows x 5 columns]"
      ]
     },
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "      <th>Sharpe Ratio</th>\n",
       "      <th>Total ESG</th>\n",
       "      <th>Sustainable Return Score</th>\n",
       "    </tr>\n",
       "  </thead>\n",
       "  <tbody>\n",
       "    <tr>\n",
      ...
      "text/plain": [
       ...
       "4   SBAC         12  0.053812       0.219269   0.206249      0.966159   \n",
       "\n",
       "   Total ESG  Sustainable Return Score  \n",
       "0     31.044                  0.111321  \n",
       "1     27.936                 10.621677  \n",
       "2     22.634                 12.501362  \n",
       "3     18.642                 -7.124479  \n",
   ...
   "source": [
    "# Make the \"Sustainable Annual Return Score\"\n",
    "df_portfolio['Sustainable Return Score'] = (df_portfolio['Annual Return'] * df_portfolio['Total ESG'])\n",
    "\n",
    "\n",
    "#sus_annual = df_portfolio['Sustainable Return Score']\n",
    "#X_scalar = StandardScaler()\n",
    "\n",
    "#X_scalar.fit(sus_annual)\n",
    "\n",
    "\n",
    "#X_scalar\n",
    "\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "4   SBAC  0.053812                0.011799            0.011099   \n",
       "\n",
       "   Weighted Sharpe Ratio  Weighted Total ESG  \n",
       "0              -0.013382           13.921076  \n",
       "1               0.367906            6.263677  \n",
       "2               0.388667            3.958413  \n",
       "3              -0.130292            1.839121  \n",
       "4               0.051991            0.875408  "
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "equity_annual_return = portfolio_metrics.loc['Portfolio Annual Return',]"
   ]
  },
  {
   "cell_type": "code",
